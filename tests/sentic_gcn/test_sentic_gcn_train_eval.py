...
class TestSenticGCNTrainTestCase(unittest.TestCase):
    def setUp(self) -> None:
        ...
        cfg = {
            ...
            "save_tokenizer_path": "",
            "embedding_model": "https://storage.googleapis.com/sgnlp-models/models/sentic_gcn/senticgcn_embedding_model/",
...
class TestSenticGCNEvaluateTestCase(unittest.TestCase):
    def setUp(self) -> None:
        ...
        cfg = {
            "eval_args": {
                "model": "senticgcn",
                "model_path": "https://storage.googleapis.com/sgnlp-models/models/sentic_gcn/senticgcn/",
                "tokenizer": "https://storage.googleapis.com/sgnlp-models/models/sentic_gcn/senticgcn_tokenizer/",
                "embedding_model": "https://storage.googleapis.com/sgnlp-models/models/sentic_gcn/senticgcn_embedding_model/",
...
class TestSenticGCNBertEvaluateTestCase(unittest.TestCase):
    def setUp(self) -> None:
        ...
        cfg = {
            "eval_args": {
                "model": "senticgcnbert",
                "model_path": "https://storage.googleapis.com/sgnlp-models/models/sentic_gcn/senticgcn_bert/",
                "tokenizer": "bert-base-uncased",
                "embedding_model": "bert-base-uncased",
                "config_filename": "config.json",
                "model_filename": "pytorch_model.bin",
