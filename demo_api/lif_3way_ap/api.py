...
# Load preprocessor
word_vocab_path = cached_path(
    "https://storage.googleapis.com/sgnlp/models/lif_3way_ap/word_vocab.pt"
)
char_vocab_path = cached_path(
    "https://storage.googleapis.com/sgnlp/models/lif_3way_ap/char_vocab.pt"
)

preprocessor = LIF3WayAPPreprocessor(
    min_word_padding_size=config.char_embedding_args["kernel_size"]
)
