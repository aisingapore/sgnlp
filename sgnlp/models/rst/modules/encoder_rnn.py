...
class EncoderRNN(nn.Module):
    ...
    def forward(self, input_embeddings: BatchEncoding, input_lengths: List[int]) -> Tuple[torch.Tensor, torch.Tensor]:
        """
        ...
        packed = nn.utils.rnn.pack_padded_sequence(embeddings, input_lengths, batch_first=True, enforce_sorted=False)
