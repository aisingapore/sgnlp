...
relation_table = [
    ...
    'Background_SN', 'Cause_NN', 'Cause_NS', 'Cause_SN',
    'Comparison_NN', 'Comparison_NS', 'Comparison_SN', 'Condition_NN',
    'Condition_NS', 'Condition_SN', 'Contrast_NN', 'Contrast_NS',
    'Contrast_SN', 'Elaboration_NS', 'Elaboration_SN', 'Enablement_NS',
    'Enablement_SN', 'Evaluation_NN', 'Evaluation_NS', 'Evaluation_SN',
    'Explanation_NN', 'Explanation_NS', 'Explanation_SN', 'Joint_NN',
    'Manner-Means_NS', 'Manner-Means_SN', 'Same-Unit_NN', 'Summary_NS',
    'Summary_SN', 'Temporal_NN', 'Temporal_NS', 'Temporal_SN',
