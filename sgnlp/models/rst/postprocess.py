    ...
    def __init__(self, detokenizer: PreTrainedTokenizer = None):
        if detokenizer is not None:
            ...
            try:
                ...
                logging.warning("Could not import nltk.treebank.TreebankWordDetokenizer. "
    ...
    def _hierplane_tree_builder_helper(self, current_node, splits_iterator, edus):
        try:
            ...
            left_node = {
                ...
                'word': self.detokenizer.detokenize(edus[current_split.left.span[0]:current_split.left.span[1] + 1])
            }
            ...
            right_node = {
                ...
                'word': self.detokenizer.detokenize(edus[current_split.right.span[0]:current_split.right.span[1] + 1])
            }
