...
class RecconSpanExtractionModel(BertForQuestionAnswering):
    ...
    Example::
        ...
        config = RecconSpanExtractionConfig.from_pretrained("https://storage.googleapis.com/sgnlp-models/models/reccon_span_extraction/config.json")
        model = RecconSpanExtractionModel.from_pretrained("https://storage.googleapis.com/sgnlp-models/models/reccon_span_extraction/pytorch_model.bin", config=config)
